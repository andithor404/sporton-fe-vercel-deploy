    ...
    return(
        <section id="products-section" className="container mx-auto mt-32">
            ...
            <div className="grid grid-cols-4 gap-5">
                {/*Looping card untuk "Our Products" */}
                {
                    productList.map((product, index) =>(
                        <Link href={"#"} key={index} className="p-1.5 bg-white hover:drop-shadow-xl duration-300">
                            <div className="bg-primary-light aspect-square w-full flex justify-center items-center relative">
                                <Button className="w-10 h-10 p-2! absolute right-3 top-3"><FiPlus size={24}></FiPlus></Button>
                            ...
                            <div className="flex justify-between mb-8">
                                ...
                                <div className="font-medium text-primary">
                                    {/* Intl.NumberFormat digunakan untuk setting currency (Rupiah)*/}
                                    {
