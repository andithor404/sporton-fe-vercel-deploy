...
const Header = () =>{
    return <header>
        <div className="flex justify-between gap-10 container mx-auto py-7 px-20">
            <Image src="/images/logo.svg" alt="Sporton Logo" width={127} height={30}></Image>
            {/* MENU */}
            ...
            <div className="flex gap-10">
                ...
                <div className="relative">
                     ...
                     <div className="bg-primary rounded-full w-3.5 h-3.5 absolute -top-1 -right-1 text-[9px] text-white text-center">3
                     </div>
                </div>
